...
function filePath(notesdir, key) { return path.join(notesdir,
`${key}.json`); }
...
export function create(key, title, body) { return crupdate(key, title,
body); }
export function update(key, title, body) { return crupdate(key, title,
body); }
